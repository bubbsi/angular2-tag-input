...
var TagInputComponent = (function () {
    function TagInputComponent(fb, elementRef) {
		...
		this.getTag = new core_1.EventEmitter();
    ...
    TagInputComponent.prototype.ngOnInit = function () {
        ...
        this.tagInputSubscription = this.tagInputField.valueChanges
            .do(function (value) {
                _this.tagInputValue = value;
                console.log(value);
                _this._emitGetTag(value);   
	...
	TagInputComponent.prototype._emitGetTag = function (tag) {
    ...
    TagInputComponent.prototype.ngOnChanges = function (changes) {
        ...
        if(changes.autocompleteItems){
            ...
            _this.autocompleteResults = _this.autocompleteItems.filter(function (item) {
                 ...
                 */
                return item.toLowerCase().indexOf(_this.tagInputValue.toLowerCase()) > -1 && _this._isTagUnique(item);
            });
        }
    };
